...
##written with no libs other than numpy
...
#original graph with deleted edges as we go
working_graph = original_graph

#new graph with edges added as we go
...
#add first elt to working graph,



#instantiate next node selection
next_node = None
#make ordered pair from rand elt's location
